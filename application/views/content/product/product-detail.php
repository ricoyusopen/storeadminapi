                    ...
                    <div class="row">
                        ...
                        <div class="col-desk-6 col-md-6 col-sm-6">
                            <div class="right-top-navigation">
                                <form action="">
                                    <div>
                                        <a href="#"><img src="<?=base_url()?>assets/icons/account-white.svg" alt=""></a>
                        ...
                        <div class="row">
                            <div class="col-desk-12 col-md-12 col-sm-12">
                                <div class="banner1-left">
                                    <img class="image-banner" src="<?=base_url()?>assets/icons/banner1.jpg">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="main-area">
                                        <div class="box-banner2-left">
                                            <a href="#">
                                                <div class="row">
                                                    <div class="col-desk-6 col-md-6 col-sm-6">
                                                        <img class="image-banner" src="<?=base_url()?>assets/icons/macbook.jpg">
                                                    </div>
                                                    <div class="col-desk-6 col-md-6 col-sm-6">
                                                        <div class="box-banner2-description">
                                                            <div class="child">
                                                                ...
                                                                <span class="price">Rp. 16.000.000,00</span><br>
                                    ...
                                    <div class="main-area">
                                        <div class="item-news-product">
                                            <div class="parent-image">
                                                <a href="#"><img class="image" src="<?=base_url()?>assets/icons/banner2.jpg" alt=""></a>
                                            </div>
                                    ...
                                    <div class="col-desk-7 col-md-7 col-sm-7">
                                        <div class="image-area">
                                            <div class="image-main">
                                                <a href="#"><img src="<?=base_url()?>assets/icons/macbook.jpg" alt=""></a>
                                            </div>
                                        ...
                                        <div class="detail-right-area">
                                            ...
                                            <div class="product-review">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <img src="<?=base_url()?>assets/icons/star.svg" alt="">
                                                            <img src="<?=base_url()?>assets/icons/star.svg" alt="">
                                                            <img src="<?=base_url()?>assets/icons/star.svg" alt="">
                                                            <img src="<?=base_url()?>assets/icons/star.svg" alt="">
                                                            <img src="<?=base_url()?>assets/icons/star.svg" alt="">
                                            ...
                                            <div class="product-price">
                                                <span class="before-discount">Rp 10.000.000,00</span><br>
                                                <span class="after-discount">Rp 7.000.000,00</span> <span>Save</span> <span class="total-discount">30%</span>
                                            </div>
