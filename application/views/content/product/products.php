              ...
              <table class="display" id="products"  style="text-align:left;font-size:14px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?= $x ?></td>
                      <td>
                        <img id="<?= $prod->product_name ?>" class="img-prod" src="<?= API_IMG.'products/'.$prod->image1 ?>" alt="" style="cursor:pointer;width:40px;height:40px;border-radius:5px;">
                        <img id="<?= $prod->product_name ?>" class="img-prod" width="50" height="50" src="<?= API_IMG.'products/'.$prod->image2 ?>" alt="" style="cursor:pointer;width:40px;height:40px;border-radius:5px;">
                        <img id="<?= $prod->product_name ?>" class="img-prod" width="50" height="50" src="<?= API_IMG.'products/'.$prod->image3 ?>" alt="" style="cursor:pointer;width:40px;height:40px;border-radius:5px;">
                        <img id="<?= $prod->product_name ?>" class="img-prod" width="50" height="50" src="<?= API_IMG.'products/'.$prod->image4 ?>" alt="" style="cursor:pointer;width:40px;height:40px;border-radius:5px;">
                      </td>
                      ...
                      <td>
                        <?php
                        if($prod->discount !=0){
                          echo "<span>Rp." .number_format($prod->price). "</span><br> ";
                          $disc = $prod->price - (($prod->discount/100)*$prod->price);
                          echo "Rp. ".number_format($disc);
                        }else{
                          $disc = $prod->price - ($prod->price * $prod->discount);
                          echo number_format($disc);
                        }
                       ?>
                      </td>
                      <td> <?= $prod->discount."%"; ?> </td>
          ...
          <div id="edit-product" class="row" style="padding:30px;display:none;">
            ...
            <table>
              <tr>
                <td colspan="2">
                  <?php for ($i=1; $i <=4 ; $i++) :?>
                  <img src="" id="img<?php echo $i;?>" src="" alt="" style="width:100px;height:100px;">
                  <?php endfor;?>
                </td>
              </tr>
              <tr>
